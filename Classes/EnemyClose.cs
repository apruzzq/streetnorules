...
namespace Les_Loubards
{
    ...
    class EnemyClose : Actor
    {
        ...
        protected EnemyCloseState state;
       ...
       protected  Vector2 retreatTarget;
       protected int attackNumber;
        ...
        /// </summary>
        public EnemyClose(Direction startingSide, Level inLevel)
        ...
        public override void Update(GameTime gT)
        {
            ...
            switch (state)
            {
                ...
                case EnemyCloseState.Retreat: // l'enemi est dans un état de fuite, de retraite ( = retreat) 
                ...
                case EnemyCloseState.MoveTo:
                    ...
                    bool linedUpX = LinedUpXWithPlayer1();
                ...
                case EnemyCloseState.PreAttack:
                    ...
                    if (LinedUpXWithPlayer1() && LinedUpYWithPlayer())
                    {
                ...
                case EnemyCloseState.Dying:
                    ...
                    if (stateTime <= 0)
                    {
                        ...
                        {
                            //Will I drop beer ?
                            if (Game1.Random.NextDouble() >= 0.7f) // le pourcentage de chance d'avoir la biere ( 0f = 100%, 0.7f = 30% de chance ...)
                            {
                                this.InLevel.GameItems.Add(
                                    new PickUpHealthPack(this.InLevel, this.Position,30));
                            }
        ...
        private bool LinedUpXWithPlayer1()
        {
        ...
        public override void GetKnockedDown(Direction cameFrom, int damage)
        {
            ...
            drawHeight = DRAW_WIDTH_KNOCKEDOWN;
            SetDrawArea();
        ...
        {
            currentFrameTime += (float)gT.ElapsedGameTime.TotalSeconds;
            if (currentFrameTime >= Actor.FrameRate*1.5)
            {
                drawWidth = DRAW_WIDHT_ATTACK1;
                drawHeight = DRAW_HEIGHT_ATTACK1;
                frameY = FRAME_Y_ATTACK1;
        ...
        {
            currentFrameTime += (float)gT.ElapsedGameTime.TotalSeconds;
            if (currentFrameTime >= Actor.FrameRate*1.5) // diminue la vitesse
            {
                currentFrameTime = 0f;
