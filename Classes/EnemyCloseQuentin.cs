...
{
    class EnemyCloseQuentin : EnemyClose
    {

        public EnemyCloseQuentin(Vector2 position, Level inLevel)
            : base(position, inLevel)
        {
         ...
         public EnemyCloseQuentin(Direction startingSide, Level inLevel)
