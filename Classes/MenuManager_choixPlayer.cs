...
namespace Les_Loubards
{
    ...
    static class MenuManager_choixPlayer
    {
        ...
        public static void Update()
        {
                ...
                || InputHelper.WasKeyPressed(Keys.Space))
            {
                ...
                {
                    case 0: //Choix 1 player
                        GameManager.NumberPlayers = 1;
                        MenuManager_ChoixNiveau.menuItems = new List<MenuItem>();
        ...
        public static void CreateMenuItems()
        {
            if (GameManager.Langage == "Francais")
            {
                ...
                menuItems.Add(new MenuItem("1 joueur", new Vector2(horPosition, verPosition)));
                menuItems.Add(new MenuItem("2 joueurs", new Vector2(horPosition2, verPosition + 30)));
                menuItems.Add(new MenuItem("Retour", new Vector2(horPosition, verPosition + 80)));
            }
            else if (GameManager.Langage == "Anglais")
            {
                menuItems.Add(new MenuItem("1 player", new Vector2(horPosition, verPosition)));
                menuItems.Add(new MenuItem("2 players", new Vector2(horPosition2, verPosition + 30)));
                menuItems.Add(new MenuItem("Back", new Vector2(horPosition, verPosition + 80)));
            }
            else if (GameManager.Langage == "Espagnol")
            {
                menuItems.Add(new MenuItem("1 jugador", new Vector2(horPosition, verPosition)));
                menuItems.Add(new MenuItem("2 jugadores", new Vector2(horPosition2, verPosition + 30)));
